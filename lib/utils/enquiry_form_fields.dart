...
/// RentNearBy.Core.Models.ServiceCategoryFormTypes on the backend) to the label EnquiryFormScreen
...
class EnquiryFormFieldConfig {
  final String? dateLabel;
  final String? peopleLabel;
  const EnquiryFormFieldConfig({this.dateLabel, this.peopleLabel});
}
...
const _kEnquiryFormFieldConfigs = <String, EnquiryFormFieldConfig>{
  'Travel': EnquiryFormFieldConfig(dateLabel: 'Preferred Travel Date', peopleLabel: 'Number of Travelers'),
  'Event': EnquiryFormFieldConfig(dateLabel: 'Event Date', peopleLabel: 'Number of Guests'),
  kFormTypeConsultation: EnquiryFormFieldConfig(dateLabel: 'Preferred Consultation Date'),
  'Education': EnquiryFormFieldConfig(dateLabel: 'Preferred Start Date', peopleLabel: 'Number of Students'),
};
...
EnquiryFormFieldConfig enquiryFormFieldConfigFor(String? formType) =>
    _kEnquiryFormFieldConfigs[formType] ?? _kEnquiryFormFieldConfigs['Travel']!;

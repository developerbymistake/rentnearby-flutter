    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _sectionBody(
            'Credits and Fees',
            'Listing a room or plot on Bakhli is free. Making a listing visible to prospective tenants ("going live") requires spending credits from your in-app credit wallet. Credits may be purchased in packs, redeemed via a coupon/redeem code, or credited to your wallet by Bakhli at its discretion; you then spend credits to go live on a listing for the plan duration you choose. All credit charges, where applicable, are borne solely by the property owner. Tenants may discover listings and reach out to owners entirely free of charge. Bakhli does not levy any commission, brokerage, or fee of any kind on rental arrangements concluded between property owners and tenants.\n\nCredit purchases are processed in Indian Rupees (INR) through a third-party payment service and are non-refundable once processed. Credits that have been spent to activate a listing are likewise not refundable or reversible. Bakhli does not store your card or bank account details.\n\nCredits have no monetary value outside Bakhli, cannot be transferred to any other user or account, and cannot be redeemed or exchanged for cash — they may only be used to activate listings on Bakhli. Bakhli may, at its sole discretion, change pricing or credit requirements, or run promotional offers (including temporarily free listing activation), at any time, without entitling existing users to a refund or adjustment.',
          ),
          _sectionBody(
            'Listing Visibility',
          ...
          _sectionBody(
            'Listing Review, Rejection, and Removal',
            'Bakhli reserves the right to review, approve, reject, or remove any listing at its sole discretion, including in response to a user report or a violation of these Terms. If a request to activate ("go live") a listing is rejected before the listing becomes live, any credits spent for that request will be refunded to your wallet. If a listing that has already been live is removed or permanently rejected due to a violation of these Terms or a valid user report, credits already spent to activate that listing will not be refunded, as the visibility service had already been provided. Such action may be taken at any time and, where reasonably possible, will include a stated reason.',
          ),
          _sectionBody(
            'Account Suspension',

    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _sectionBody(
            'Coins and Fees',
            'Listing a room or plot on Bakhli is free. Making a listing visible to prospective tenants ("going live") requires spending coins from your in-app coin wallet. Coins may be purchased in packs, redeemed via a coupon/redeem code, or credited to your wallet by Bakhli at its discretion; you then spend coins to go live on a listing for the plan duration you choose. All coin charges, where applicable, are borne solely by the property owner. Tenants may discover listings and reach out to owners entirely free of charge. Bakhli does not levy any commission, brokerage, or fee of any kind on rental arrangements concluded between property owners and tenants.\n\nCoin purchases are processed in Indian Rupees (INR) through a third-party payment service and are non-refundable once processed. Coins that have been spent to activate a listing are likewise not refundable or reversible. Bakhli does not store your card or bank account details.',
          ),
          _sectionBody(
            'Listing Visibility',

        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _section(
            ...
            [
              ...
              'Push notification token — used to deliver app notifications relevant to your account, such as updates on your listings, inquiries, or messages.',
              ...
              'Local service inquiry details — when you submit an inquiry for a local service, your name, contact details, and inquiry information are shared with the relevant independent service provider ("Agent") solely to connect you with them.',
            ],
          ),
          _section(
            ...
            [
              ...
              'To deliver push notifications relevant to your account, listings, or inquiries.',
              'To enable and maintain conversations between users through Bakhli\'s chat feature.',
              'To connect you with the relevant Agent when you submit a local service inquiry.',

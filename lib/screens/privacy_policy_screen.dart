        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _section(
            ...
            [
              ...
              'Push notification token — used to deliver app notifications relevant to your account, such as updates on your listings, enquiries, or messages.',
              'Chat messages — when you use Bakhli\'s structured Q&A-based chat feature to communicate with another user, your messages are stored to enable and maintain that conversation.',
              'Local service enquiry details — when you submit an enquiry for a local service, your name, contact details, and enquiry information are shared with the relevant independent service provider ("Agent") solely to connect you with them.',
            ],
          ),
          _section(
            ...
            [
              ...
              'To deliver push notifications relevant to your account, listings, or enquiries.',
              'To enable and maintain conversations between users through Bakhli\'s chat feature.',
              'To connect you with the relevant Agent when you submit a local service enquiry.',
          ...
          _sectionBody(
            ...
            'Your account information and listings are retained for as long as your account remains active. You may request deletion of your account at any time through the profile settings. Upon deletion, all associated data — including listings, photos, and wallet/credit transaction records — is permanently removed from our systems. This right is provided in accordance with the Digital Personal Data Protection Act, 2023.',
          ),
          _sectionBody(
            'Security',

...
class _AddListingScreenState extends State<AddListingScreen> with AddListingLocationMixin<AddListingScreen> {
  ...
  static const _locationStyle = LocationStepStyle(
    circleColorHex: '#2f64ca',
    userDotColorHex: '#1E88E5',
    accentColor: AppColors.primary,
    addressSpinnerColor: AppColors.primaryLight,
    addressPrefixIcon: Iconsax.building,
    pinStepTitle: 'Pin Your Location *',
    pinHintNoun: 'room',
  );
    ...
    return PopScope(
      ...
      body: Column(children: [
        ...
        Container(
          ...
          if (_step == 2 && showAddressResolveOverlay) AppLoadingOverlay.stackChild(message: 'Please wait...'),
        ],
      ),
    );
  }
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      _sectionCard(
        ...
        child: Obx(() {
          ...
          if (types.isEmpty && _ctrl.roomTypesLoading.value) {
          ...
          if (types.isEmpty) {
            return GestureDetector(
              onTap: _ctrl.loadRoomTypes,
              child: const Padding(
                padding: EdgeInsets.symmetric(vertical: 12),
                child: Center(
                  child: Text(
                    "Couldn't load room types. Tap to retry.",
